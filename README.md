...
| `BUILDSCAD_OPENSCAD_VERSION` | No | — | Required OpenSCAD version. Supports exact match (`2021.01`), minimum (`>=2021.01`), or maximum (`<=2021.01`). If set, the build will fail if the installed OpenSCAD version does not match. |
